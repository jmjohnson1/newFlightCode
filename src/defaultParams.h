...
constexpr float PARAM_DEFAULT_1  = 0.50f;
constexpr float PARAM_DEFAULT_2  = 0.34f;
constexpr float PARAM_DEFAULT_3  = 1.66f;
constexpr float PARAM_DEFAULT_4  = 0.50f;
constexpr float PARAM_DEFAULT_5  = 0.34;
constexpr float PARAM_DEFAULT_6  = 0.11f;
constexpr float PARAM_DEFAULT_7  = 0.0f;
constexpr float PARAM_DEFAULT_8  = 0.1f;
constexpr float PARAM_DEFAULT_9  = 3.5f;
constexpr float PARAM_DEFAULT_10 = 1.0f;
constexpr float PARAM_DEFAULT_11 = 4.0f;
constexpr float PARAM_DEFAULT_12 = 7.0f;
constexpr float PARAM_DEFAULT_13 = 4.0f;
constexpr float PARAM_DEFAULT_14 = 9.0f;
